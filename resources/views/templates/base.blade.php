    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <li><a href="{{route('galeria.index')}}" class="nav-link px-2 @if ($pagina == 'galeria') text-secondary @else text-white @endif">Galeria</a></li>
        </ul>

        <div class="text-end">
          @if (Auth::user())
            Olá, <a href="{{ route('perfil.index') }}" role="button" class="btn btn-outline-primary"> {{ Auth::user()->username}} !</a>
